...
#export RhcosAmi=$([ "$arch" = "aarch64" ] && echo ami-03c5697f9a0b458d8 || echo ami-04d1dcb37d29f4da0) # Version 4.20.10
#export RhcosAmi=$([ "$arch" = "aarch64" ] && echo ami-0bc01c2ad16fef268 || echo ami-021b5ab76f755886f) # Version 4.20.0
